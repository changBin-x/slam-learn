/*
 * @Date: 2020-11-24 17:34:34
 * @LastEditTime: 2020-11-24 20:07:40
 * @Author:  Chang_Bin
 * @LastEditors: Chang_Bin
 * @Email: bin_chang@qq.com
 * @Description:本教程演示了如何从范围图像中提取NARF(法线对齐的径向特征)关键点。
 * 可执行文件使我们能够从光盘加载点云（或在未提供时创建点云），提取其上的兴趣点并在图像和3D查看器中可视化结果。
 */
